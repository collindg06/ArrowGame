# This program is a test for the program that simulates the client side of a client/server connection using udp that allows the user to play a game of archery against the computer. 
...
def userInput(windPower, windDirectional, windWay):
    ...
    while(invalidation == 1):
        ...
        # Apply test inputs
        ("How much power do you want to give? ")
        power = str(int(540/windPower))

        ("Do you want to aim to the north or south? ")
        ...
        ("How far to that side do you want to aim it? ")
        aim = str(1)
